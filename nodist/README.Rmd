...
Ack! Well, that didn't go so well. Another approach is needed here. Probably this will have
to use the sum of logs of chi-squares distribution and a transform.
