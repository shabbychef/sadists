...
```{r sumchisq,eval=TRUE,echo=TRUE,dpi=200,out.width='600px',out.height='700px'}
require(sadists)
wts <- c(1,-3,4)
df <- c(100,20,10)
ncp <- c(5,3,1)
...
```{r sumchi,eval=TRUE,echo=TRUE,dpi=200,out.width='600px',out.height='700px'}
require(sadists)
wts <- c(-3,2,5,-4,1)
...
```{r lambdap,eval=TRUE,echo=TRUE,dpi=200,out.width='600px',out.height='700px'}
require(sadists)
df <- 50
ts <- 1.5
...
```{r upsilon,eval=TRUE,echo=TRUE,dpi=200,out.width='600px',out.height='700px'}
require(sadists)
df <- c(30,50,100,20,10)
ts <- c(-3,2,5,-4,1)
...
```{r nakagami,eval=TRUE,echo=TRUE,dpi=200,out.width='600px',out.height='700px'}
require(sadists)
m <- 120
Omega <- 4
