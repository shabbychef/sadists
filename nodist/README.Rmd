...
opts_chunk$set(fig.width=6,fig.height=7,dpi=200,out.width='700px',out.height='900px')
...
```{r sumchisq,eval=TRUE,echo=TRUE}
require(sadists)
wts <- c(1,-3,4)
df <- c(100,20,10)
ncp <- c(5,3,1)
...
```{r nakagami,eval=TRUE,echo=TRUE}
require(sadists)
m <- 120
Omega <- 4
