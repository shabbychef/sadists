...
rf <- rdnbeta(2^14,df1=df1,df2=df2,ncp1=ncp1,ncp2=ncp2)
pv <- pdnbeta(rf,df1=df1,df2=df2,ncp1=ncp1,ncp2=ncp2)
qv <- qdnbeta(ppoints(length(rf)),df1=df1,df2=df2,ncp1=ncp1,ncp2=ncp2)
```
